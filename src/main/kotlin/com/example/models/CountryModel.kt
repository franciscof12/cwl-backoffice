...
data class Country(
    val cId: String,
    val fkCIdTblLanguages: String?,
    val fkSCurrencyTblCurrencies: String,
    val sBillingCurrency: String?,
    val sName: String,
    val bIsActive: Boolean,
    val bIsSandboxActive: Boolean?,
    val sSimilarNames: String?,
)
