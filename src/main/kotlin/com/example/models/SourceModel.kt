...
@Serializable
data class Source(val iIdL: Int, val fkCIdTblCountries: String, val fkIIdTblVertical: Int, val fkIidTblParserTypes: Int, val bActive: Boolean)

object Sources : Table("tbl_vertical") {
